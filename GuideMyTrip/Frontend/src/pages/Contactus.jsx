...
function Contactus() {
  ...
  const handlesubmit = async (e) => {
    e.preventDefault();
    const response = await axios.post("http://localhost:3000/contactus/post",contactdata)
      ...
      <div className='flex bg-secondary h-[550px] m-5 w-1/2  rounded-2xl'>
        <div className=' flex flex-col justify-center h-[530px] mx-40 my-5 w-80 gap-5 '>
          ...
          <label className="form-control">
            ...
            <textarea onChange={handlefeedback} value={contactdata.comment} className="textarea textarea-bordered h-40" placeholder="Type a messsage"></textarea>
          </label>
